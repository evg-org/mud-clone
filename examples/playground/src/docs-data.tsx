...
export const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/segmented-control", label: "Segmented Control", needsReview: false, visualGroup: "selection-controls" },
      { href: "/input-text", label: "Input: Text", needsReview: false, visualGroup: "inputs" },
      { href: "/input-numeric", label: "Input: Numeric", needsReview: false, visualGroup: "inputs" },
      { href: "/input-date", label: "Input: Date", needsReview: false, visualGroup: "inputs" },
      { href: "/input-phone-number", label: "Input: Phone Number", needsReview: false, visualGroup: "inputs" },
